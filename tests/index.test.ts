...
import { Transfer, Mint, Approval } from "../generated/artblocks/artblocks"
import { handleTest, handleMint, handleTransfer, handleApproval } from "../src/mappings"
...
test("handleApproval",
	() => {
		...
		let approved = Address.fromString(ADDRESS_ZERO)
		let tokenId = BigInt.fromI32(666)
